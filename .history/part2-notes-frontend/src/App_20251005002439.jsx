        ...
        <div className="bg-amber-500/20 flex flex-col items-center justify-center p-8 rounded-xl w-full max-w-xs mt-6">
          ...
          <form
            ...
            <input
              ...
              type="number"
            />
            <button className="bg-amber-500 text-white p-2 rounded-xl mt-2 cursor-pointer hover:bg-amber-600/70 duration-100 transition shadow-sm hover:shadow-xl hover:shad">
              Submit
            </button>
          </form>
        </div>
