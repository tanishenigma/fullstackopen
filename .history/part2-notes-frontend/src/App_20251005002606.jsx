...
const App = () => {
  ...
  return (
    <div className="min-h-screen  flex flex-col md:flex-row">
      {/* Sidebar */}
      <aside className="w-full md:w-1/3 xl:w-1/3 flex flex-col items-center  md:border-r border-amber-600/20 py-10 px-4 shadow-2xs">
        ...
        />
        {/* Add new contact */}
        <div className="bg-amber-500/20 flex flex-col items-center justify-center p-8 rounded-xl w-full max-w-xs mt-6">
