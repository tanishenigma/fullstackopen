...
const App = () => {
  ...
  return (
    <div className="min-h-screen  flex flex-col md:flex-row">
      {/* Sidebar */}
      <aside className="w-full md:w-1/3 xl:w-1/3 flex flex-col items-center  md:border-r border-amber-600/20 py-10 px-4 shadow-md">
        ...
        <input
          className="border mb-4 rounded-full p-2 border-amber-200 bg-amber-800/10 focus:outline-none w-full max-w-xs"
          value={search}
          onChange={(e) => setSearch(e.target.value)}
          placeholder="Search by name or phone"
        />
        {/* Add new contact */}
        <div className="bg-amber-500/20 flex flex-col items-center justify-center p-8 rounded-xl w-full max-w-xs mt-6 shadow-2xs">
          ...
          <form
            ...
            <input
              className="border mb-2 rounded-full p-2 border-amber-200 bg-amber-800/10 focus:outline-none"
            ...
            <input
              ...
              type="number"
            />
            <button className="bg-amber-500 text-white p-2 rounded-xl mt-2 cursor-pointer hover:bg-amber-600/70 duration-100 transition shadow-sm hover:shadow-md hover:shadow-amber-950/20">
              Submit
            </button>
          </form>
        </div>
